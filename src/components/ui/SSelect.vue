  ...
  >
    ...
    <SelectPortal>
      <SelectContent
        ...
        class="z-400 max-h-60 w-[var(--reka-select-trigger-width)] overflow-hidden rounded-xl bg-surface-bright shadow-lg app-no-drag data-[state=open]:animate-select-in data-[state=closed]:animate-select-out"
      >
